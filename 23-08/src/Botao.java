...
public class Botao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Insira um endereço:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jLabel1.setText("Botão programado");
        jLabel1.setForeground(Color.blue);
        System.out.println("O endereço inserido foi: " + jTextField1.getText());
        if(jTextField1.getText().length()<15){
            
        }
        else{
            JOptionPane.showMessageDialog(this, "O endereço é muito extenso");
            jTextField1.setText("");
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JOptionPane.showMessageDialog(this, "Criado por Paulo André");
