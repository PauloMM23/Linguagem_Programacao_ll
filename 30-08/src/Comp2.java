public class Comp2 extends javax.swing.JFrame {
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        //System.out.println("jRadioButton2 selecionado");
    }//GEN-LAST:event_jRadioButton2ActionPerformed

    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        //System.out.println("jRadioButton1 selecionado");
    }//GEN-LAST:event_jRadioButton1ActionPerformed

    private void jRadioButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton3ActionPerformed
        //System.out.println("jRadioButton3 selecionado");
    }//GEN-LAST:event_jRadioButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jRadioButton1.isSelected()){
            jTextField1.setText("Masculino selecionado");
        }
        else if (jRadioButton2.isSelected() || jRadioButton3.isSelected()){
            if (jRadioButton2.isSelected())
                jTextField1.setText("Feminino selecionado");
            else{
                jTextField1.setText("Prefere não informar");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Comp2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
